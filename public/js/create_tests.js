...
$('.edit-question').on('click', function(e){
    ...
    if(!$(this).parent().parent().parent().find('.question').hasClass('editing')){
        ...
        $(this).parent().parent().parent().find('.question').append('<p class="edit-field"><textarea cols="40">'+$(this).parent().parent().parent().find('.question').html()+'</textarea></p><p class="q-options-diff"><select name="diff"><option disabled selected value="0">Трудност</option><option value="1">лесен</option><option value="2">нормален </option><option value="3">труден </option></select>&nbsp;&nbsp;бонус:&nbsp;<input type="number" class="bonus-points" min="0" value="'+bonusP+'"></p>').addClass('editing');
