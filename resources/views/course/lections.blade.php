    ...
    <div class="section">
        ...
        <div class="col-md-12 lvl-program-holder d-flex flex-row flex-wrap">
            ...
            <div class="col-md-12 text-center homework-stats-user" title="Качени домашни / прегледани домашни">
                <i class="fas fa-upload"></i> {{Auth::user()?Auth::user()->getUploadedHomeworksCount($module->id,Auth::user()->id):0}} / <i class="fas fa-eye"></i> {{Auth::user()?Auth::user()->getHomeWorkEvalCountModule($module->id,Auth::user()->id):0}}
                </div>
