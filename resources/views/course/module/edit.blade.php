    ...
    <div class="tab-body module-body-right position-relative">
        ...
        <div class="row g-0 mt-5">
            <div class="col me-lg-4">
                <input type="text" name="starts" class="form-module date-input w-100" placeholder="Начало (дата)" aria-label="Начало (дата)" value="{{ $module->Course->starts ? $module->Course->starts->format('m/d/Y') : null }}">
            </div>
            <div class="col ms-3">
                <input type="text" name="ends" class="form-module date-input w-100" placeholder="Край (дата)" value="{{ $module->Course->ends ? $module->Course->ends->format('m/d/Y') : null }}">
            </div>
        </div>
        <div class="row g-0 mt-5">
            <div class="col">
