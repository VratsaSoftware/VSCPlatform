...
@section('content')
	...
	<div class="">
		...
		<div class="col-md-12 d-flex flex-row flex-wrap options-wrap">
			<div class="col-md-12" style="margin-bottom:2vw;">
				...
				Краен срок : {{isset($lection->homework_end)?$lection->homework_end->subDays(1):'-'}}
			</div>
						...
						<td>
							...
							<div class="comments-homework" style="display:none;">
								...
								@foreach ($homework->Comments as $comment)
									<!-- one comment -->
										@if(!is_null($comment->Author) && !is_null($comment->comment))
											@php
	...
	<div class="col-md-1 download-stats" style="bottom:1%;font-size:200%;position:fixed;left:-1%"><i class="fas fa-download"></i></div>
