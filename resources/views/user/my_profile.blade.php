        ...
        <div class="col-md-12 header-name d-flex flex-row flex-wrap">
            ...
            <div class="col-md-6 header-pic">
                <div class="col-md-12">
                    ...
                    @else
                        <img src="{{asset('images/user-pics/'.Auth::user()->picture)}}" alt="profile-pic"
                             class="profile-pic">
                    @endif
            ...
            <div class="col-md-4 header-contacts text-right">
                <div class="col-md-12">
                    <a href="#" class="facebook" target=" _blank"><img
                                src="{{asset('/images/profile/facebook-icon.svg')}}" alt="fb"></a>
                    <p class="edit-social"><input type="text" id="facebook" name="facebook" value="{{old('facebook')}}">
                    </p>
                    <a href="#" class="linkedin" target=" _blank"><img
                                src="{{asset('/images/profile/linkdin-icon.svg')}}" alt="li"></a>
                    <p class="edit-social"><input type="text" id="linkedin" name="linkedin" value="{{old('linkedin')}}">
                    </p>
                    <a href="#" class="github" target=" _blank"><img src="{{asset('/images/profile/github-icon.svg')}}"
                                                                     alt="gh"></a>
                    <p class="edit-social"><input type="text" id="github" name="github" value="{{old('github')}}"></p>
                    <a href="#" class="skype" target=" _blank"><img src="{{asset('/images/profile/skype-icon.svg')}}"
                                                                    alt="sk"></a>
                    <p class="edit-social"><input type="text" id="skype" name="skype" value="{{old('skype')}}"></p>
                    <a href="#" class="dribbble" target=" _blank"><img
                                src="{{asset('/images/profile/dribble-icon.svg')}}" alt="dr"></a>
                    <p class="edit-social"><input type="text" id="dribbble" name="dribbble" value="{{old('dribbble')}}">
                    </p>
                    <a href="#" class="behance" target=" _blank"><img
                                src="{{asset('/images/profile/behance-icon.svg')}}" alt="be"></a>
                    <p class="edit-social"><input type="text" id="behance" name="behance" value="{{old('behance')}}">
                    </p>
                    ...
                    @endforeach
                    <button type="submit" value="submit" class="edit-btn btn btn-success social-edit"
                            id="submit-social">
                        <i class="fas fa-pencil-alt"></i>
                    </button>
                </div>
                            ...
                            <div class="col-md-7 text-center d-flex flex-row flex-wrap">
                                @forelse ($certificate['Courses']['Lecturers'] as $lecturer)
                                    ...
                                    <span class="col-md-4 text-right"
                                          style="padding:0"> {{$lecturer['User']->name}} {{$lecturer['User']->last_name}}</span>
                                    <br/>
                                @empty
                                    <span></span>
                                @endforelse
                ...
                <div class="col-md-12 stats-box edu-wrapper">
                                    ...
                                    <label class="switch">
                                        @if(Auth::user()->isVisible('образование'))
                                            <input type="checkbox" class="edu-visibility" checked
                                                   data-url="{{route('user.section.visibility')}}">
                                        @else
                    ...
                    <div class="col-md-12 stats-text">
                        @forelse ($education as $edu)
                            <form action="{{route('update.education')}}" id="edu-form-{{$edu->id}}" name="edu-form"
                                  method="POST" class="update_form">
                                {{ csrf_field() }}
                                <input type="hidden" name="edu_id" value="{{$edu->id}}">
                                <i class="far fa-calendar-alt"></i><br/>
                                <span class="section-el-bold live-edu edu-y-from">{{$edu->y_from}}&nbsp;/&nbsp;</span><span
                                        class="section-el-bold live-edu edu-y-to">{{$edu->y_to}}</span> <br>
                                <input type="number" id="edu_y_from-live" min="1900" max="2099" step="1" name="y_from"
                                       class="section-el-bold edit-edu" value="{{$edu->y_from ?? null}}"
                                       title="1900-2099"><br/>
                                <input type="number" id="edu_y_to-live" min="1900" max="2099" step="1" name="y_to"
                                       class="section-el-bold edit-edu" value="{{$edu->y_to ?? null}}"
                                       title="1900-2099"><br/>
                                ...
                                <select name="edu_institution_type" id="edu_institution_type"
                                ...
                                <input type="text" id="institution_name_live" name="institution_name"
                                       value="{{$edu['EduInstitution']->name}}"
                                       class="section-el-bold edit-edu institution_name">
                                ...
                                @if(isset($edu['EduSpeciality']->name))
                                    ...
                                    <input type="text" name="specialty" id="specialty"
                                           value="{{$edu['EduSpeciality']->name}}"
                                           class="section-el-bold edit-edu specialty">
                                    <p class="suggestion-ins-name"></p>
                                @else
                                ...
                                @endif
                                <textarea name="edu_description" id="edu_description"
                                          placeholder="{{$edu->description}}" style="overflow:auto;resize:none" rows="5"
                                          class="edit-edu" form="edu-form-{{$edu->id}}">{{$edu->description}}</textarea>
                                <p>
                                    <button value="запази" class="btn btn-success edit-edu submit-edu"><i
                                                class="fas fa-save"></i></button>
                                    <button class="btn btn-info edit-edu edu-add-new"><i class="fas fa-plus"></i>
                                    </button>
                                </p>
                            </form>
                            <form action="{{ route('delete.education',$edu->id) }}" method="POST"
                                  onsubmit="return ConfirmDelete()" id="delete-edu">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                <button type="submit" class="btn btn-danger edit-edu" value="DELETE"><i
                        ...
                        <span class="create-form">
                            <form action="{{route('create.education')}}" id="edu-form-create-1" name="edu-form"
                                  method="POST">
                                {{ csrf_field() }}
                                <i class="far fa-calendar-alt"></i><br/>
                                Година от:
                                <input type="number" id="edu_y_from" name="y_from" min="1900" max="2099"
                                       class="section-el-bold" value="{{old('y_from')}}" title="1900-2099"><br/>
                                Година до:
                                <input type="number" id="edu_y_to" name="y_to" min="1900" max="2099"
                                       class="section-el-bold" value="{{old('y_to')}}" title="1900-2099"><br/>
                                ...
                                <input type="text" name="institution_name" id="institution_name"
                                       ...
                                       placeholder="име на институцията..." data-url="{{route('edu.institution')}}">
                                <p class="suggestion-ins-name"></p>

                                <i class="fas fa-address-card"></i><br>
                                <input type="text" name="specialty" id="specialty" value="{{old('specialty')}}"
                                       class="section-el-bold specialty" placeholder="специалност..."
                                       data-url="{{route('edu.institution')}}">
                                <p class="suggestion-ins-name"></p>
                ...
                <div class="col-md-12 stats-box work-wrapper">
                    ...
                    <div class="col-md-12 stats-text">
                        @forelse ($workExp as $exp)
                            <form action="{{route('update.work.experience')}}" id="work-form-update-{{$exp->id}}"
                                  name="work-form-update" method="POST" class="update_form_work">
                                {{ csrf_field() }}
                                <input type="hidden" name="work_id" value="{{$exp->id}}">
                                <i class="far fa-calendar-alt"></i><br/>
                                <span class="section-el-bold work-years live-work">{{$exp->y_from->format('Y-m-d')}}&nbsp;/&nbsp;</span><span
                                        class="section-el-bold live-work">{{is_null($exp->y_to)?null: $exp->y_to->format('Y-m-d')}}</span><br/>
                                <input type="date" id="y_from_work" name="y_from" class="section-el-bold edit-work"
                                       value="{{$exp->y_from->format('Y-m-d') ?? null}}"><br/>
                                <input type="date" id="y_to_work" name="y_to" class="section-el-bold edit-work"
                                       value="{{is_null($exp->y_to)?null: $exp->y_to->format('Y-m-d')}}"><br/>

                                <i class="fas fa-building"></i>
                                <span><br/>Компания :</span><br/>
                                <span class="section-el-bold work-company live-work">{{$exp['Company']->name}}</span>
                                <input type="text" name="work_company" id="work_company_live"
                                       value="{{$exp['Company']->name}}" class="section-el-bold edit-work"><br/>

                                <i class="fas fa-id-card"></i>
                                <span><br/>Позиция :</span><br/>
                                <span class="section-el-bold work-position live-work">{{$exp['Position']->position}}</span>
                                <input type="text" name="work_position" id="work_position_live"
                                       value="{{$exp['Position']->position}}" class="section-el-bold edit-work"><br/>
                                ...
                                <textarea name="work_description" id="work_description"
                                          placeholder="{{$exp->description}}" style="overflow:auto;resize:none" rows="5"
                                          class="edit-work"
                                          form="work-form-update-{{$exp->id}}">{{$exp->description}}</textarea>
                                <p>
                                    <button value="запази" class="btn btn-success edit-work"><i class="fas fa-save"></i>
                                    </button>
                                    <button class="btn btn-info edit-work work-add-new"><i class="fas fa-plus"></i>
                                    </button>
                                </p>
                            </form>
                            <form action="{{ route('delete.work.experience',$exp->id) }}" method="POST"
                                  onsubmit="return ConfirmDelete()" id="delete-edu">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                <button type="submit" class="btn btn-danger edit-work" value="DELETE"><i
                                            class="fa fa-trash" aria-hidden="true"></i></button>
                            </form>
                            <hr>
                        @empty
                        ...
                        <span class="create-form-work">
                            <form action="{{route('create.work.experience')}}" id="work-form-create-1"
                                  name="work-form-create" method="POST">
                                {{ csrf_field() }}
                                <i class="far fa-calendar-alt"></i><br/>
                                Година от:
                                <input type="date" id="y_from" name="y_from" class="section-el-bold"
                                       value="{{old('y_from')}}"><br/>
                                Година до:
                                <input type="date" id="y_to" name="y_to" class="section-el-bold"
                                       value="{{old('y_to')}}"><br/>

                                <i class="fas fa-building"></i><br/>
                                <input type="text" class="section-el-bold" name="work_company"
                                       value="{{old('work_company')}}" id="work_company"
                                       placeholder="Компания/Фирма..."><br/>

                                <i class="fas fa-id-card"></i><br/>
                                <input type="text" class="section-el-bold" name="work_position"
                                       value="{{old('work_position')}}" id="work_position"
                                       placeholder="Позиция..."><br/>

                                <i class="fas fa-align-left"></i><br/>
                                <textarea name="description" id="description" placeholder="описание..."
                                          style="overflow:auto;resize:none" rows="5" class="section-el-bold"
                                          form="work-form-create-1"></textarea><br/>

                                <p>
                                    <button value="запази" class="btn btn-success"><i class="fas fa-save"></i></button>
                                    <button class="btn btn-info edit-work work-add-new"><i
                ...
                <div class="col-md-12 stats-box interest-wrapper">
                    ...
                    <div class="col-md-12 stats-text">
                        @forelse($hobbies as $hobbie)
                            <form action="{{ route('delete.hobbie',$hobbie->id) }}" method="POST"
                                  onsubmit="return ConfirmDelete()" id="delete-edu">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                                ...
                                @else
                                    ...
                                    <button type="submit" class="btn btn-danger edit-hobbie" value="DELETE"><i
                                                class="fa fa-trash" aria-hidden="true"></i></button>
                                    <button class="btn btn-info edit-hobbie hobbie-add-new"><i class="fas fa-plus"></i>
                                    </button>
                                    <hr>
                            </form>
                            @endif
                        ...
                        <span class="create-form-hobbies">
                            <form action="{{route('create.hobbies')}}" id="hobbies-form-create"
                                ...
                                <p>
                                    ...
                                    <p>
                                        <button value="запази" class="btn btn-success"><i
                                                    class="fas fa-save"></i></button>
                                        <button class="btn btn-info edit-hobbie hobbie-add-new"><i
                                                    class="fas fa-plus"></i></button>
                                    </p>
                            </form>
                        </span>
