                                ...
                                <p>
                                    ...
                                    <label for="lecturer">Лектор(и):
										...
										<select name="lecturers[]" id="lecturers[]" class="section-el-bold" multiple style="width:50%">
                                            ...
                                            <option value="{{$lecturer->id}}" {{in_array($lecturer->id,$course->Lecturers->pluck('user_id')->toArray())?'selected':''}}>{{$lecturer->name}} {{isset($lecturer->last_name)?$lecturer->last_name:''}}</option>
                                        @endforeach
                                    </select>
                                </p>
                                @endif
