...
@section('content')
    ...
    <div class="col-md-12 text-center contacts-wrapper">
        <p>
            <i class="fas fa-search-location"></i> Враца, ул. Кокиче 14 (Общинския център срещу Езиковата гимназия, от страната на автогарата)
        </p>
        <p>
            <a href="tel:+359 88 207 6174"><i class="fas fa-mobile-alt"></i> тел.: +359 88 207 6174</a>
        </p>
        <p>
            <a href="mailto:school@vratsasoftware.com"><i class="far fa-envelope"></i> ел.поща: school@vratsasoftware.com</a>
        </p>
