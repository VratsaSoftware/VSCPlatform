    ...
    <div id="banks" class="col-md-12 test-wrapper d-flex flex-row flex-wrap">
        ...
        <div class="col-md-4 test-nav d-flex flex-row flex-wrap">
            ...
            <div class="col-md-12 d-flex flex-row flex-wrap bank-holder">
                ...
                <span class="col-md-5 text-center"><i class="fas fa-book"></i>&nbsp;{{$bank->questions_count}}&nbsp;<i class="fas fa-medal"></i>&nbsp;{{$bank->difficultyCount['hard']}}</span>
            </div>
                    ...
                    <ul class="list-group tests-list">
                        ...
                        <div class="col-md-12 q-open-wrap">
                            <div class="col-md-12 questions-box q-open">
                                ...
                                <input type="radio" name="bonus" value="0" id="no-bonus" checked> <label for="no-bonus">Без Бонус</label>&nbsp;&nbsp;
                                <input type="radio" name="bonus" value="1" id="yess-bonus"> <label for="yess-bonus">Бонус</label>
                        ...
                        <div class="col-md-12 q-one-wrap">
                            <div class="col-md-12 questions-box q-one">
                                ...
                                <p class="input-answers">
                                    <a href="" class="icon-click"><i class="fas fa-check-circle"></i></a>&nbsp;<input type="text" class="q-one-answer"><a href="" class="remove-q modal-remove-q"><i class="fas fa-times"></i></a>
                                </p>
                        ...
                        <div class="col-md-12 q-many-wrap">
                            <div class="col-md-12 questions-box q-many">
                                ...
                                <p class="input-answers">
                                    <a href="" class="icon-click-many"><i class="fas fa-check-circle"></i></a>&nbsp;<textarea class="q-many-answer" cols="30"></textarea><a href="" class="remove-q"><i class="fas fa-times"></i></a>
                                </p>
                        ...
                        @foreach($bank->Questions as $question)
                            @if($question->type == 'open')
                                ...
                                @endswitch
                                    ...
                                    <div class="col-md-5 text-right">
                                        ...
                                        <span class="col-md-2"><a href="" class="edit-question"><i class="fas fa-pencil-alt"></i></a></span>
                                        <span class="col-md-2"><a href=""><i class="fas fa-times"></i></a></span>
                                    </div>
                                    </p>
                                    <p>
                                    <div class="col-md-12">
                            ...
                            <!-- /multiple -->
                                ...
                                <div class="col-md-5 text-right">
                                    <span class="col-md-4"><i class="far fa-check-square"></i></span>
                            ...
                            @if($question->type == 'one')
                                ...
                                <p>
                                <div class="col-md-7 question">
                                    Коя функция може да се използва за извличане на масив от наличните опции в stream контекста?
                                </div>
                                <div class="col-md-5 text-right">
                                    <span class="col-md-4"><i class="far fa-dot-circle"></i></span>
            ...
            <div class="col-md-12 text-center">
                <a href="#modal" class="add-bank">
                    <img src="./images/profile/add-icon.png" alt="add">&nbsp;Добави Банка
                </a>
                <div class="col-md-12 create-bank">
                    <form action="./proceed.html" id="create-bank-form">
                        <p>
                        ...
                        <p>
                            <input type="file" name="new_type_img">
                        </p>
                        <hr>
                        <div class="add-banks-template col-md-12">
                            <p>
                                Въпроси:<select name="types">
                            ...
                            <div class="d-flex flex-row flex-wrap col-md-12">
                                <div class="col-md-4">Лесни : <input type="number"></div>
                                <div class="col-md-4">Средни : <input type="number"></div>
                                <div class="col-md-4">Трудни : <input type="number"></div>
                            </div>
                            <hr>
                        </div>
                        <div class="col-md-12 add-more-options">
                            <a href=""><img src="./images/profile/add-icon.png" alt="add"></a>
                        </div>
                        <script>
