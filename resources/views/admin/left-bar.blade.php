<div class="left-navigation">
    <ul class="nav navbar-nav sidenav">
        ...
        <li class="nested-nav {{ Route::is('course.create') ? 'sidenav-selected' : '' }} {{ Route::is('course.show') ? 'sidenav-selected' : '' }}">
            <a href="" id="my-courses"><i class="fas fa-chevron-down"></i>Kурсове</a>
            <ul>
                <li><a href="{{route('course.create')}}"><img src="{{asset('/images/profile/add-icon.png')}}"
                                                              alt="add"></i>Добави</a></li>
                <li><a href="{{route('all.courses')}}"><img src="{{asset('/images/profile/education-icon.png')}}"
                                                            alt="view" class="view_all_courses_icon">виж всички</a></li>
            </ul>
        </li>
        <li class="nested-nav">
        ...
        <li class="nested-nav">
            <a href="{{route('polls.index')}}">
                <img src="{{asset('/images/profile/nav/grades-icon.png')}}" alt="" class="img-fluid">Анкети
            </a>
        </li>
        <li class="nested-nav">
